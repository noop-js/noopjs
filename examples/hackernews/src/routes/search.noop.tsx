    ...
    <div style="padding:12px">
      <div style="margin-bottom:16px">
        <input
          ...
          onInput={function(e: Event) { query.set((e.target as HTMLInputElement).value); }}
        ...
        <button
          onClick={function() {
            if (!query.get()) return;
            loading.set(true);
            fetch('https://hn.algolia.com/api/v1/search?query=' + encodeURIComponent(query.get()) + '&page=0').then(function(r) { return r.json(); }).then(function(r) { results.set(r); loading.set(false); }).catch(function() { loading.set(false); });
          }}
